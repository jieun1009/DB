...
1. <span style="background-color=#fffb15;"> @Configuration </span> : 설정파일을 만들기 위한/Bean을 등록하기 위한 애노테이션, 스프링의 설정 클래스임을 의미 (설정클래스 = bean)<br><Br>
...
4. @Import : 두개 이상의 설정 파일일때 사용. @Import해서 다른 설정 파일을 임포트하면 스프링 컨테이너에 **최상위 설정 클래스** 한 개만 사용
